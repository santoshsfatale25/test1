...
for kk=1:NumberOfIterations
    ...
    %% Exponential inter-arrival time
    time=cumsum(exprnd(1,NumberOfRequests,1));
    producersRequest_Zipf=datasample(1:Producers,NumberOfRequests,'Weights',ProducersProbability_Zipf');
...
hit_rate_total_Sim_Zipf_LeastExpe_Average=mean(hit_rate_total_Sim_Zipf_LeastExpe);
hit_rate_total_Sim_Zipf_LeastExpe_stdDev=std(hit_rate_total_Sim_Zipf_LeastExpe,1,1);

hit_rate_total_Sim_Zipf_LRU_Average=mean(hit_rate_total_Sim_Zipf_LRU);
hit_rate_total_Sim_Zipf_LRU_stdDev=std(hit_rate_total_Sim_Zipf_LRU,1,1);

hit_rate_total_Sim_Zipf_RAND_Average=mean(hit_rate_total_Sim_Zipf_RAND);
hit_rate_total_Sim_Zipf_RAND_stdDev=std(hit_rate_total_Sim_Zipf_RAND,1,1);

hit_rate_total_Sim_Zipf_SMP_Average=mean(hit_rate_total_Sim_Zipf_SMP);
